...
| @docs/16-product-baseline-2026-09-18.md | Synthetic DEL-01 fixtures, 100/1,000/10,000 full-inventory REST timings, and consent-safe measurement status | Before changing UI loading/grouping behavior |
...
| @docs/22-next-five-task-execution-plan-2026-09-23.md | Reconciled next-five queue: dependency PR triage, corrected release, full-inventory benchmarks, first-run guidance, and an opt-in agent management skill | Before selecting or executing the next audit-derived task |
| @docs/23-github-actions-dependency-pr-review-2026-09-23.md | Dated, evidence-backed verdicts for the five open GitHub Actions dependency PRs | Before updating or integrating those action pins |
